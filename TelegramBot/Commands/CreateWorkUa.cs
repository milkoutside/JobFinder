...
public class CreateWorkUa : Command
{
    ...
    public override string Name { get; } = "/creatework";
        ...
        switch (state.StateCommand)
        {
            ...
            case "post":
                ...
                else
                {
                    ...
                    await client.SendTextMessageAsync(chatId,
                        "Город, где будете работать? (Ввводить транслитом с укр на англ, а так же с маленькой буквы) " +
                        "\n Пример: kyiv | kharkiv");
                }
                break;
            case "job":
